...
## 1 Задача: Надежный клиент для внешнего API
Описание
...
Критерии оценки:
4 балла - исходный код реализованной функции
1 балл - демонстрация работы функции

## 2 Задача: Реализация Circuit Breaker для клиента API
Описание
...
stateDiagram-v2
    ...
    Closed --> Closed : Успешные запросы
    Closed --> Open : Достижение порога ошибок
    Open --> Open: Продолжение ошибок
    Open --> HalfOpen : Таймаут
    HalfOpen --> Open : Повторы ошибок
    HalfOpen --> Closed : Успешные запрос
```
...
В домашнем задании необходимо:
Предоставить исходный код в архиве, скриншоты
Также можно приложить демонстрацию как работает функция
